        ...
        <header class="masthead">
            <div class="header-top">
                <div class="container">
                    ...
                    <a class="navbar-brand hidden-xs" href="./"><img src="assets/webbenny-02.png" alt="Site Logo"></a>
                    ...
                    <nav class="sidebar-menu">
                        <a class="navbar-brand" href="index.php"><img src="assets/webbenny1.png" width="200" height="100" alt="Site Logo"></a>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div id="main-menu" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                               ...
                               <li class="menu-item">
                                    <a href="?module=earthwork">Earthwork</a>
                                </li>
                                <li class="menu-item">
                                    <a href="?module=geotech">Geotech</a>
                                </li>
                              
                                <li class="menu-item"><a href="?module=hidro">Hidrologi</a></li>
                                <li class="menu-item"><a href="?module=ipal">IPAL</a></li>
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-2">
                        <aside class="sidebar text-justify">
                            <div class="widget">
                                <h3 class="widget-title">Laporan Terkini</h3><!-- /.widget-title -->
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Shun <i class="fa fa-" aria-hidden="true"></i>
                    </div><!-- /.copyright -->
                </div>
